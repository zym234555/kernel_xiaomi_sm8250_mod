...
if [ $KSU_ENABLE -eq 1 ]; then
    echo "KSU is enabled"
    curl -LSs "https://raw.githubusercontent.com/zym234555/SukiSU-Ultra/main/kernel/setup.sh" | bash -s zym234555
else
...
local_version_date_str="-zym234555-$(date +%Y%m%d)-${GIT_COMMIT_ID}-perf"
